...
target "aitraining_jupyterlab_perceval_perceval0-4-2_py39_cpu" {
  dockerfile = "Dockerfile"
  target     = "base_aitraining"
  cache-from = CACHE_FROM
  tags       = ["${RIBS_PREFIX}aitraining/jupyterlab-perceval:perceval0.4.2-py39-cpu${VERSION_SUFFIX}"]
  args = {
    base_FROM                                       = "ubuntu:18.04"
    base_editor_jupyterlab_labPipVersion            = "22.0.4"
    base_editor_jupyterlab_labVersion               = "3.3.4"
    ...
    workspace_commonlibs_key                        = "install"
    workspace_conda_MINICONDA                       = "https://repo.anaconda.com/miniconda/Miniconda3-py39_4.10.3-Linux-x86_64.sh"
    workspace_framework_fmt                         = "perceval0.4.2"
    workspace_framework_key                         = "perceval"
    workspace_framework_perceval_version            = "0.4.2"
  }
}
target "aitraining_vscode_perceval_perceval0-4-2_py39_cpu" {
  dockerfile = "Dockerfile"
  target     = "base_aitraining"
  cache-from = CACHE_FROM
  tags       = ["${RIBS_PREFIX}aitraining/vscode-perceval:perceval0.4.2-py39-cpu${VERSION_SUFFIX}"]
  args = {
    base_FROM                                       = "ubuntu:18.04"
    base_editor_key                                 = "vscode"
    workspace_FROM                                  = "ubuntu"
...
target "notebooks_jupyterlab_perceval_perceval0-4-2_py39_cpu" {
  dockerfile = "Dockerfile"
  target     = "base"
  cache-from = CACHE_FROM
  tags       = ["${RIBS_PREFIX}notebooks/jupyterlab-perceval:perceval0.4.2-py39-cpu${VERSION_SUFFIX}"]
  args = {
    base_FROM                                       = "ubuntu:18.04"
    base_editor_jupyterlab_labPipVersion            = "22.0.4"
    base_editor_jupyterlab_labVersion               = "3.3.4"
...
target "notebooks_vscode_perceval_perceval0-4-2_py39_cpu" {
  dockerfile = "Dockerfile"
  target     = "base"
  cache-from = CACHE_FROM
  tags       = ["${RIBS_PREFIX}notebooks/vscode-perceval:perceval0.4.2-py39-cpu${VERSION_SUFFIX}"]
  args = {
    base_FROM                                       = "ubuntu:18.04"
    base_editor_key                                 = "vscode"
    workspace_FROM                                  = "ubuntu"
